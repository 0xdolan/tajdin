  ...
  return (
    <div className="flex min-w-0 shrink-0 items-center gap-2">
      ...
      <select
        ...
        className="max-w-full rounded-md border border-neutral-600 bg-neutral-900 px-2 py-1.5 text-sm text-neutral-200 outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-500/30"
        value={value}
