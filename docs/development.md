...
- [ ] **Popup** opens from the toolbar icon and shows the basic Tajdîn UI (dark shell, title, main tabs including **About**, bottom **Player** bar: station line above controls, prev/play/next, random-from-list (shuffle-style icon), mute + volume with custom slider track).
